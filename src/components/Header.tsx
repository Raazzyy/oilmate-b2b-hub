    ...
    <header className="sticky top-0 z-50 w-full bg-card">
      ...
      <div className="container py-4">
        <div className="flex items-center gap-4">
          {/* Catalog button */}
          <Button className="hidden md:flex gap-2 gradient-primary hover:gradient-primary-hover text-primary-foreground font-semibold px-6 h-12 rounded-full shrink-0 transition-all">
